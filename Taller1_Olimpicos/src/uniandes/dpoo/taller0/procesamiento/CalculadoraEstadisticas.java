...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Indica cual es el país correspondiente a un atleta dado por parametro
	 * 
	 * @param nombreAtleta El nombre del atleta a consultar su país
	 * @return Nombre del país al que pertenece el atleta.
	 * 
	 *         Si el nombre no corresponde al de ningún atleta, retorna null.
	 */

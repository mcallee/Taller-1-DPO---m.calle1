...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar país que representa un atleta");
	...
	{
		String nombre_atleta = input("Escriba el nombre del atleta de su interés");
		String pais_representado = calculadora.paisesEnRango(nombre_atleta);
		System.out.println("El pais representado por "+ nombre_atleta + " es "+ pais_representado );
